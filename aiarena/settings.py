...
CONSTANCE_CONFIG = {
    ...
    'PATREON_CREATOR_REFRESH_TOKEN': ('', 'Creator refresh token for general API usage under the AI Arena credentials.'),
...
AVATAR_DEFAULT_URL = "avatar/img/default_author.jpg"
