...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "result",
                    models.CharField(
                        choices=[("none", "None"), ("win", "Win"), ("loss", "Loss"), ("tie", "Tie")], max_length=32
                    ),
                ),
                (
                    "result_cause",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="bots", to=settings.AUTH_USER_MODEL
                    ),
                ),
            ],
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        upload_to=aiarena.core.models.map.map_file_upload_to,
                    ),
                ),
                ("active", models.BooleanField(default=False)),
            ],
        ...
        migrations.CreateModel(
            ...
            bases=(
                models.Model,
                aiarena.core.models.mixins.LockableModelMixin,
                aiarena.core.models.mixins.RandomManagerMixin,
            ),
        ),
        migrations.CreateModel(
            name="News",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "icon",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="core.TrophyIcon"
                    ),
                ),
            ],
        ),
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        null=True,
                        storage=aiarena.core.storage.OverwriteStorage(),
                        upload_to=aiarena.core.models.competition_participation.elo_graph_upload_to,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
                        related_name="season_matchup_stats",
                        to="core.SeasonParticipation",
                    ),
                ),
                (
                    "opponent",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "replay_file",
                    models.FileField(blank=True, null=True, upload_to=aiarena.core.models.result.replay_file_upload_to),
                ),
                ("game_steps", models.IntegerField(db_index=True)),
                (
                    "arenaclient_log",
                    models.FileField(
                        blank=True, null=True, upload_to=aiarena.core.models.result.arenaclient_log_upload_to
                    ),
                ),
                ...
                (
                    "match",
                    models.OneToOneField(
                        on_delete=django.db.models.deletion.CASCADE, related_name="result", to="core.Match"
                    ),
                ),
                (
                    "submitted_by",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        blank=True,
                        choices=[("none", "None"), ("win", "Win"), ("loss", "Loss"), ("tie", "Tie")],
                        max_length=32,
                        null=True,
                    ),
                ),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to="core.Round"
            ),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "arenaclient",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, related_name="statuses", to="core.ArenaClient"
                    ),
                ),
            ],
        ),
