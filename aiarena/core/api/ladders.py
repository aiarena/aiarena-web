...
class Ladders:
    @staticmethod
    def get_season_ranked_participants(season: Competition, amount=None):
        ...
        return CompetitionParticipation.objects.raw(query, (season.id, last_round.id,))

    @staticmethod
    def get_most_recent_round(season: Competition):
