...
# Export a single competition
# DJANGO_ENVIRONMENT=DEVELOPMENT uv run python manage.py export_parquet competition 42

# Export all competitions closed in a given year
# DJANGO_ENVIRONMENT=DEVELOPMENT uv run python manage.py export_parquet all_competitions 2025

# Export requested matches for a specific user in a given year
# DJANGO_ENVIRONMENT=DEVELOPMENT uv run python manage.py export_parquet requested 123 2025

# Export all requested matches for a given year
# DJANGO_ENVIRONMENT=DEVELOPMENT uv run python manage.py export_parquet all_requests 2025

# Optional: specify a custom output directory
# DJANGO_ENVIRONMENT=DEVELOPMENT uv run python manage.py export_parquet competition 42 --output-dir ./exports
