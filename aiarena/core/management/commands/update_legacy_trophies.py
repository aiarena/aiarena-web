...
class Command(BaseCommand):
    ...
    COMPETITION_ALIASES = {
        "ai arena melee season 1": "Sc2 AI Arena Season 1",
        "arena melee ladder season 1": "Sc2 AI Arena Season 1",
        "ai arena melee season 2": "Sc2 AI Arena Season 2",
        "arena melee ladder season 2": "Sc2 AI Arena Season 2",
    }
    ...
    CONDITION_PATTERNS = (
        ...
        (
            re.compile(r"\btop\s*20\b", re.IGNORECASE),
            ("top_20",),
        ),
        (
            re.compile(r"\btop\s*15\b", re.IGNORECASE),
            ("top_15",),
        ),
        (
            re.compile(r"\btop\s*10\b", re.IGNORECASE),
            ("top_10",),
        ),
        (
    ...
    @classmethod
    def parse_condition(cls, trophy_name, allowed_conditions):
        for pattern, candidate_values in cls.CONDITION_PATTERNS:
    ...
    @staticmethod
    def parse_source_name(trophy_name):
        """
        Extract the event name from historical trophy-name formats.
