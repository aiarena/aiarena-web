...
class Command(BaseCommand):
    help = (
        "Recalculates a competition's ELOs based on all matches for that competition. This can take a VERY long time. "
    ...
    def handle(self, *args, **options):
        ...
        with transaction.atomic():
            ...
            matches = (
                ...
                .filter(round__competition=target_competition, result__isnull=False)
