...
class Command(BaseCommand):
    help = 'Recalculates a competition\'s ELOs based on all matches for that competition. This can take a VERY long time. ' \
           'WARNING! No transaction is used - nothing else should attempt to modify the database while this runs.'
    ...
    def handle(self, *args, **options):
        ...
        matches = Match.objects.filter(round__competition=target_competition, result__isnull=False)\
        ...
        for match in matches:
            ...
            p1.starting_elo = sp1.elo
            p2.starting_elo = sp2.elo
