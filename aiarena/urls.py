...
urlpatterns = [  # todo: replace usage of url with path for all these
    ...
    path("competitions/stats/<int:pk>/overview/", core_views.frontend),
    path("competitions/stats/<int:pk>/overview/elograph/", core_views.frontend),
    path("competitions/stats/<int:pk>/overview/winsbytime/", core_views.frontend),
    path("competitions/stats/<int:pk>/overview/winsbyrace/", core_views.frontend),
    path("competitions/stats/<int:pk>/maps/", core_views.frontend),
    path("competitions/stats/<int:pk>/matchups/", core_views.frontend),
