        ...
        <div className="flex flex-col flex-1 bg-customBackgroundColor1 p-6 rounded-lg shadow-lg relative overflow-hidden m-8">
          ...
          <div className="mb-4 relative">
            <Image
              ...
              src={`${process.env.PUBLIC_PREFIX}/demo_assets/adj_1_1.png`}
              height={500}
              width={500}
          ...
          <div className="flex-grow mt-6">
            <p className="text-gray-300 mb-4">
              Follow our comprehensive guide to build your first model and
              prepare it for competitive battling.
            </p>
          </div>
          <div className="mt-4">
            <button
        ...
        <div className="flex flex-col flex-1 bg-customBackgroundColor1 p-6 rounded-lg shadow-lg relative overflow-hidden m-8">
          ...
          <div className="mb-4 relative">
            <Image
              ...
              src={`${process.env.PUBLIC_PREFIX}/demo_assets/adj_2_1.png`}
              height={500}
              width={500}
              className="w-full h-auto rounded-lg"
            />
          ...
          <div className="flex-grow mt-6">
            <p className="text-gray-300 mb-4">
              Create an account and start competing in the ladder to showcase
              your model&apos;s prowess.
            </p>
          </div>
          <div className="mt-4">
            <button
