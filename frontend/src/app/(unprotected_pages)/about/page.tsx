      ...
      <ArticleWrapper className="bg-customBackgroundColor2 text-white">
        ...
        <section className="py-12 bg-customBackgroundColor2D1">
          ...
          <p className="mb-4 text-lg max-w-2xl mx-auto text-center leading-relaxed">
            By supporting AI Arena, you help us maintain and expand our
            platform. Donations fund server costs, streaming improvements, and
            new features to enhance the competitive AI experience. Our financial
            details are publicly accessible for transparency. Learn more in our{" "}
            <a
